...
with st.sidebar:
    st.image("C:\\Users\\HP\\Desktop\\vs code\\1706102332371.png")
...
uri = "mongodb+srv://Pava007:J3DmpmWFSSsFNiHH@cluster0.6vclwug.mongodb.net/"
client = MongoClient(uri, server_api=ServerApi('1'))
db = client.sample_airbnb
col = db.listingsAndReviews

# READING THE CLEANED DATAFRAME
df = pd.read_csv("C:\\Users\\HP\\Desktop\\vs code\\airbnb1.csv")
...
if selected == "Home":
    ...
    #st.image(Image.open("C:\\Airbnb\\country.jpg"),width = 400)   
